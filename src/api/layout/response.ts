import { user, user_role, role_route, route } from '/@/api/layout/data/user'
...
export const getUser1 = function(name: string):{name:string, role: Array<string>} {
    return {
        name,
